...
export const Minimizable = ({ children, size = 'h-[15rem] w-[24rem]', fullSize, minimized }: Props): JSX.Element => {
  ...
  const child = minimized || <div className={`relative  ${childStyle}`}>{minimized || children}</div>
