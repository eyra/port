...
export var RadioInputFactory = function (props) { return _jsx(RadioInput, __assign({}, props)); };
export var RadioInput = function (props) {
    ...
    function handleConfirm() {
        ...
        if (item !== undefined) {
            resolve === null || resolve === void 0 ? void 0 : resolve({ __type__: 'PayloadString', value: item });
        }
    }
...
export var RadioItem = function (_a) {
    ...
    return (_jsxs("div", __assign({ id: "".concat(id), className: 'radio-item flex flex-row gap-3 items-center cursor-pointer', onClick: function () { return onSelect(id); } }, { children: [_jsxs("div", { children: [_jsx("img", { src: RadioSvg, id: "".concat(id, "-off"), className: selected ? 'hidden' : '' }), _jsx("img", { src: RadioActiveSvg, id: "".concat(id, "-on"), className: selected ? '' : 'hidden' })] }), _jsx("div", __assign({ className: 'text-grey1 text-label font-label select-none mt-1' }, { children: value }))] })));
};
